...
> **Observed (fill in when Task 0 runs):** _(leave this blockquote for whoever executes the plan to fill in, matching the pattern in `docs/superpowers/plans/2026-07-14-teable-migration.md` Task 0 — this is not a plan placeholder, it's a required execution-time note.)_
